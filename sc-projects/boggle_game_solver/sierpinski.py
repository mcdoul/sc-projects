...
def main():
	"""
	The programs draws Sierpinski Triangles
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: It controls the recursive depth of fractal
	:param length: the length of each side of the triangle
	:param upper_left_x: the x-coordinate of the upper left vertex of triangle
	:param upper_left_y: the y-coordinate of the upper left vertex of triangle
	:return: the final drawing
	"""
	if order == 0:
		return
	else:
